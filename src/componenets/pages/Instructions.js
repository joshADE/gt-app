...
function Instructions() {
    return (
        <React.Fragment>
            ...
            <p>To add a course:</p>
            <ol style={listStyle}>
                <li>First make sure that the term for the course exist. This can be done by clicking the &aposAdd a new term&apos button. The term number should be displayed on the left side.</li>
                <li>Once the correct term exist, locate the corresponding &aposadd course&apos field for the term.</li>
                <li>Enter the course code for the course in the field, and press enter or click the &aposAdd a new course&apos button.</li>
                <li>If the course ws successfully added, a cell should appear with the course code in the table.</li>
                <li>You can change the name, course code, and credits by edit the remaining fields then clicking &aposSet changes&apos</li>
            </ol> 
            </div>
            ...
            <ol style={listStyle}>
                <li>First select a course by clicking on the &aposSelect&apos button on any one of the course cells.</li>
                ...
                <strong>Note: Once you have finished, make sure to click &aposAccept changes&apos button at the bottom of the panel</strong>
                <li>You can not only add courses, but remove and change the courses by clicking on the &aposx&apos beside each course code.</li>
            ...
            <ol style={listStyle}>
                ...
                <strong>Note: Once you have finished, make sure to click &aposAccept changes&apos button at the bottom of the panel</strong>
                <li>You can also change and remove the courses by clicking on the &aposx&apos beside each course code.</li>
